...
Summary(pl.UTF-8):   Sterowniki jądra Linuksa dla modemów programowych Smart Link
...
%description -n kernel-char-slmdm -l pl.UTF-8
Sterowniki jądra Linuksa dla modemów programowych Smart Link.
...
%description -n kernel-char-slmdm-amr -l pl.UTF-8
...
%description -n kernel-char-slmdm-usb -l pl.UTF-8
Sterowniki jądra Linuksa dla modemów programowych Smart Link. Ten
